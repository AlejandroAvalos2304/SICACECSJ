            ...
            <div class="modal-body">
                <div class="demo-masked-input">
                    <div class="row clearfix">
                        ...
                        <div class="col-sm-3 col-xs-10 selectContainer">
                            <b>Materia</b>
                            <select id="estadofam" name="materia" class="form-control show-tick" style="width: 100%;">
                                <option value="0">Seleccione...</option>
                                <option value="1">Matématica</option>
...
<div class="modal fade" id="ModalVer" tabindex="-2" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <hr class="sidebar-divider d-none d-md-block">
            <div class="modal-footer">
                <button type="button" class="btn btn-primary"><i class="material-icons">print</i>Imprimir</button>
                <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="material-icons">close</i>Cerrar</button>
            </div>
        </div>
    </div>
