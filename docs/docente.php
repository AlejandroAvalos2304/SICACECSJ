...
<?php include('../docs/AgregarDModal.php');?>
...
<script type="text/javascript" class="init">
        function Alertabaja(id, nombre, apellido) {
            ...
            alertify.confirm("<center>ATENCI&Oacute;N!</center>", "<center><img src='../images/warning.png' width='230' height='230'></center>" + "<center><h1>¿Desea Dar De Baja A?</h1></center>  <center><h2 style='font-style:italic';> " + nombre + " " + apellido + "  </h2></center>",
        ...
        function r() {
            location.href = ("../docs/docente.php");
        }


        function alertaExito() {
            alertify.success("<h1>Exito</h1>" + "<p>Se dio de baja exitosamente</p>" + "<img src='../images/bien.png'>").set({
                transition: 'flipx'
            });
        }
            ...
            <div class="media-body">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <a href="../docs/docente.php" title="Ayuda">
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">                            
                                <button type="button" class="btn btn-primary waves-effect waves-float" style="float: right;" data-toggle="modal" data-target="#exampleModalD"><img src="../images/iconos/registrar.svg"/>
                                    Registrar Docente
                                </button>                                
                            </ul>
                        </div>
                            ...
                            <div class="table-responsive dataTable">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $fila["nombresd"]; ?></td>
                                            <td><?php echo $fila["apellidosd"]; ?></td>
                                        ...
                                        <?php include('../docs/VerDModal.php');?>
                                            <td>
                                            ...
                                            <?php include('../docs/EditarDModal.php');?>
                                            <td>
