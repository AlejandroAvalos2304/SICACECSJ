...
<head>
    ...
    <title>Tabla Alta-Alumnos</title>
    <!-- Favicon-->
    ...
    <script type="text/javascript" class="init">
        function Alta(aid, anombre, aapellido) {

            alertify.confirm("<center>ATENCI&Oacute;N!</center>", "<center><img src='../images/warning.png' width='200' height='200'></center>" + "<center><h2>¿Desea Dar De Alta A?</h2></center>  <center><h3>  " + anombre + " " + aapellido + "  </h3></center>",
                ...
                function() {
                    ...
                    document.getElementById('baccion').value = aid;
        ...
        function r() {
            location.href = ("../docs/altaA.php");
        }


        function alertaExito() {
            alertify.success("<p>Se dio de Alta exitosamente</p>" + "<img src='../images/bien.png' width='80' height='80'>").set({
                transition: 'flipx'
            });
        }

        function alertaError() {
            alertify.error("<p>No se puedo dar de Alta</p>" + "<img src='../images/error.png' width='80' height='80'>").dismissOthers();
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            $query_s = pg_query($conexion, 'SELECT * from alumnos where estadoa=0 order by idalum');
                                            while ($fila = pg_fetch_array($query_s)) {
                                                ?>
                                                <tr>
                                                    <td style="font-size:15px"><?php echo $alnombre = $fila[1]; ?></td>
                                                    <td style="font-size:15px"><?php echo $alapellido = $fila[2]; ?></td>                                                    
                                                    <td>
                                                        <a class="btn btn-success waves-effect waves-float" onClick="Alta('<?php echo $alid = $fila[0]; ?>','<?php echo $alnombre; ?>','<?php echo $alapellido; ?>')"><img src="../images/iconos/baseline-thumb_up-24px.svg" /></a>
                                                    </td>
                                                </tr>
...
if (isset($_REQUEST["bandera"])) {
    ...
    if ($bandera == "alta") {
        ...
        $result = pg_query($conexion, "UPDATE alumnos SET estadoa='$estadoa' where idalum='$baccion'");
